...
✅ **智能解析** - 自动识别标准docx格式（ZIP包），彻底解决乱码问题  
✅ **兼容回退** - 自动回退到二进制提取模式，兼容旧版特殊格式文档  
✅ **保持段落** - 保留原文档的段落结构  
...
**Q: 为什么有些文档转换后乱码？**  
A: v1.1版本已修复此问题！现在工具会优先使用标准docx解析（ZIP格式），彻底解决乱码。对于特殊格式文档，会自动回退到二进制提取模式。
...
### v1.1 (2026-01-30)
- ✨ **新增**: 智能docx解析，标准格式文档优先使用ZIP解析
- 🐛 **修复**: 彻底解决docx文件转换乱码问题
- 🔄 **优化**: 保留二进制提取作为回退方案，兼容旧版特殊格式
